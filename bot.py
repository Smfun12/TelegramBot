...
async def start_cmd_handler(message: types.Message):
    ...
    user_dictionary[message.from_user.id] = "Username: " + message.from_user.username + ", first_name: " + message.from_user.first_name + ", last_name: " + message.from_user.last_name
